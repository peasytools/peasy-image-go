// Demo script for peasy-image-go — PeasyImage API client.
...
import (
	...
	peasy "github.com/peasytools/peasy-image-go"
)
...
func main() {
	...
	fmt.Println("\n=== Search: 'resize' ===")
	results, err := client.Search(ctx, "resize")
	if err != nil {
		log.Fatal(err)
	}
